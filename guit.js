...
var noteValues = [{note:"C", color: "#0072ff"},{note:"C#", color: "#00deff"},{note:"D", color: "#00ff7e"}, {note:"D#", color: "#b4ff00"}, {note:"E", color: "#f0ff00"}, {note:"F", color: "#ff8400"}, {note:"F#", color: "#ff5a00"}, {note:"G", color: "#ff0030"}, {note:"G#", color: "#ff00c0"}, {note:"A", color: "#b400ff"}, {note:"A#", color: "#6600ff"}, {note:"B", color: "#0006ff"}]; 
...
function changeColor(val){
 ...
 //
////
////// down here only works second time, not first or after....
